...
public class UIManager : MonoBehaviour {
    ...
    //call when behavior is disabled
    void OnDisable()
    {
        events.UpdateQuestionUI -= UpdateQuestionUI;
        events.DisplayResolutionScreen -= DisplayResolution;
    ...
    //called right as script is loaded
    void Start()
    {
        UpdateScoreUI();
    ...
    // creates new answers to questions
