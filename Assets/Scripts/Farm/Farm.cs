...
public class Farm : MonoBehaviour
{
    ...
    private FarmSquare currentSquare;

    void Start()
    {
        // bounds of farmland
        minBounds = new Vector3(-11.25f, float.MaxValue, -10.5f);
        maxBounds = new Vector3(11.25f, float.MaxValue, 2f);
    ...
    void Update()
    {
        currentSquare = IsOnFarmland() ? GetFarmSquare() : null;
    }
